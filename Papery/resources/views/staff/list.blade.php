...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12">
            ...
            <h3>
                <span class="page-title">Staff Data</span>
                <a href="/staff/adding" class="btn btn-add btn-sm float-end">+ Data</a>
            </h3>
                ...
                <div class="card-body p-0">
                    <table class="table table-bordered table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <td>{{ $loop->iteration + $staffList->firstItem() - 1 }}</td>
                                <td class="text-start">{{ $row->st_name }}</td>
                                <td class="text-start">{{ $row->st_email }}</td>
                                <td>
                                    <a href="/staff/{{ $row->id }}" class="btn btn-warning btn-sm">Edit</a>
                                </td>
                                <td>
                                    <a href="/staff/reset/{{ $row->id }}" class="btn btn-warning btn-sm">Reset</a>
                                </td>
                                <td>
