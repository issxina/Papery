                ...
                <div class="card-body">
                    <form action="/category" method="post">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="category_name" required placeholder="Enter name" value="{{ old('category_name') }}">
                                @error('category_name')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="category_slug" required placeholder="Enter name Eng" value="{{ old('category_slug') }}">
                                @error('category_slug')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
